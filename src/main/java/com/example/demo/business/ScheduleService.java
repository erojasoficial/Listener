...
public class ScheduleService {
    private final MailBatchLauncher mailBatchLauncher;

    public ScheduleService(MailBatchLauncher mailBatchLauncher) {
        this.mailBatchLauncher = mailBatchLauncher;
    }
    ...
    public void sendMessage() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException {
        ...
        if (message != null) {
            try {
                mailBatchLauncher.launch(message);
            } catch (Exception e) {
